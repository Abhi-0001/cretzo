...
// setTimeout(() => {
//     alert("running");
//     $(`#add-scroll-js`).html('<div style="background: red;">test</div>');
// },5000);
// $('#add-scroll-js').html(`
// <style>
// .chat-ui {
...
//             E-Shop Assistant <span class="dot"></span>
//         </div>
//     </div>
...
//     <div class="chat-grid">
//         <div class="chat-btn">📦 Track My Order</div>
//         <div class="chat-btn">❌ Cancel Order</div>
//         <div class="chat-btn">🔄 Return Item</div>
//         <div class="chat-btn">💳 Payment Issue</div>
//         <div class="chat-btn">🛍 Product Inquiry</div>
//         <div class="chat-btn">🎧 Talk to Support</div>
//     </div>
