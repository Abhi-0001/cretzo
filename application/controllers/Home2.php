...
class Home extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(['address_model','home_model', 'category_model', 'product_model', 'brand_model', 'cart_model', 'faq_model', 'blog_model', 'ion_auth_model']);
    ...
    public function index()
    {
        ...
        $categories = $this->category_model->get_categories('', 20);
        $brands = $this->brand_model->get_brands('', $limit, $offset, $sort, $order, 'false');
        $sellers =  $this->home_model->approved_home_seller();
        ...
        $this->data['centerSlider'] = get_sliders('','center');
        $this->data['bottomSlider'] = get_sliders('','bottom');
        $this->data['sellers'] = $sellers;
        $this->load->view('front-end/' . THEME . '/template', $this->data);
    }

    function filterCustomProducts($item) {
        return $item['product_type'] === 'custom_products';
    }
    ...
    public function categories()
    {
        ...
        $this->data['categories'] = $cats = $this->category_model->get_categories('', $limit, $offset, $sort, $order, 'false');
