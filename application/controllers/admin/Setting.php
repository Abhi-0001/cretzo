...
class Setting extends CI_Controller
{
    ...
    public function update_system_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $this->form_validation->set_rules('tds_percent_no_pan', 'TDS without PAN (%)', 'trim|numeric|greater_than_equal_to[0]|less_than_equal_to[100]|xss_clean');
            // No upper bound: the threshold is a rupee amount, not a percentage.
            $this->form_validation->set_rules('tds_threshold_amount', 'TDS threshold', 'trim|numeric|greater_than_equal_to[0]|xss_clean');
