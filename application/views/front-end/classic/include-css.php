...
<!-- ===== FIXES ===== -->
<style>
    /* FIX: Address popup modal z-index */
    .modal-backdrop { z-index: 99998 !important; }
    .modal { z-index: 99999 !important; }
    #add-address-modal { z-index: 99999 !important; }
    #edit-address-modal { z-index: 99999 !important; }

    /* FIX: Select2 city/pincode dropdown floats over everything */
    .select2-container--open .select2-dropdown { z-index: 1000000 !important; }
    .select2-dropdown { z-index: 1000000 !important; }

    /* FIX: product permission icons */
    .product-permission i {
        font-size: 26px;
        display: block;
        text-align: center;
        margin-bottom: 4px;
