            ...
            <div class="col-md-8 col-12">
                ...
                <?php if (!isset($orders['order_data']) && empty($orders['order_data']) || $orders['order_data'] == []) { ?>
                    ...
                    <div class="align-items-center d-flex flex-column">
                        <img src="<?= base_url('assets/front_end/classic/images/empty-orders.webp') ?>" alt="Empty Orders" class="w-23" />
                            ...
                            <div class="card-header bg-white p-2">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="flex-col my-auto d-flex gap-2">
                                        ...
                                        ?>
                                        <button class="button button-secondary button-sm reorder-btn" data-variants="<?= $variants ?>" data-quantity="<?= $qty ?>">Reorder</button>
                                    </div>
                                </div>
                            </div>
