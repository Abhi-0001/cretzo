...
$this->load->view('front-end/' . THEME . '/partials/legal-page', [
    'legal_key'   => 'terms',
    'legal_title' => !empty($this->lang->line('terms_and_condition')) ? $this->lang->line('terms_and_condition') : 'Terms of Use',
    'legal_body'  => isset($terms_and_conditions) ? $terms_and_conditions : '',
]);
