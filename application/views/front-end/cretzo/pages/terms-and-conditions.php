        ...
        <div class="container py-3 py-md-5">
            <nav class="d-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page"><?= !empty($this->lang->line('terms_and_condition')) ? $this->lang->line('terms_and_condition') : 'Terms & Condition' ?></li>
                </ol>
            </nav>
            <!-- /nav -->
        </div>
...
<section class="container main-content mb-15 my-4">
    <div class="text-center">
        <h1 class="display-2"><?= !empty($this->lang->line('terms_and_condition')) ? $this->lang->line('terms_and_condition') : 'Terms & Conditions' ?></h1>
    </div>
