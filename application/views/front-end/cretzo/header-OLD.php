        ...
        <header class="wrapper bg-light">
                ...
                <ul class="icon-container">
                    ...
                    <li class="icon">
                        <a href="<?= base_url('my-account/favorites') ?>" class="nav-link" aria-label="favorites">
                            <img class="icon-img" src="<?= base_url('assets/front_end/cretzo/img/new_cretzo/heart-icon.png') ?>">
                        </a>
                    ...
                    <li class="icon">
                        ...
                        <p class="icon-num"><?= (count($this->cart_model->get_user_cart($this->session->userdata('user_id'))) != 0 ? count($this->cart_model->get_user_cart($this->session->userdata('user_id'))) : '0'); ?></p>
                    </li>
                ...
                <div class="mobile-header">
                    ...
                    <ul class="icon-container-m">
                        ...
                        <?php if ($page == 'checkout') { ?>
                            <li class="icon">
                                <a href="<?= base_url('cart') ?>">
                                    <img class="icon-img-m" src="<?= base_url('assets/front_end/cretzo/img/new_cretzo/cart-icon.png') ?>">
                                </a>
            ...
            <section class="navbar-container">
                <ul class="navbar-list">
                    ...
                    <li class="dropdown shop-all-li" style="margin-right: 1em;">
                        <a class="nav-btn fs-14 mb-0 nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Shop All
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <?php echo generateDropdownItemsForCategories($categories); ?>
                        </ul>
                    </li>

                    <!-- only the main categories (top level, no nested ones) -->
                    <?php foreach ($categories as $key => $row) { ?>
                        <li class="dropdown">
                            <!-- <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>" class="text-decoration-none">
                                <h6 class="nav-btn fs-14 mb-0"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', $row['name'])) ?></h6>
                            </a> -->
                            ...
                            <a class="nav-link" href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <h6 class="nav-btn fs-14 mb-0"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', $row['name'])) ?></h6>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <!-- We use the same function but we put the category in an empty array to only run on this category -->
                                <?php echo generateDropdownItemsForCategories($row['children']); ?>
                            </ul>
