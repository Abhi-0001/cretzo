    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h4 class="mb-0"><i class="fas fa-location-arrow mr-2 text-primary-theme"></i>Cities</h4>
                    <p class="text-muted mb-0 small">Cities available across the platform.</p>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card attribute-card">
                <div class="card-header attribute-card-header">
                    <span class="header-icon bg-set"><i class="fas fa-location-arrow"></i></span>
