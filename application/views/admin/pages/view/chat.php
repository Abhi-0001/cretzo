<div class="content-wrapper admin-chat-page">
                    ...
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                        <div class="card shadow-sm border-0" style="border-radius: 20px;">
                            <div class="card-body text-center px-5 py-5">
                                <div class="d-inline-flex align-items-center justify-content-center mb-4" style="width: 110px; height: 110px; border-radius: 50%; background: var(--color-orange-light);">
                                    <i class="fas fa-comments" style="font-size: 54px; color: var(--color-orange);"></i>
                                </div>
