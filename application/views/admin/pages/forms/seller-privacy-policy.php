<div class="content-wrapper admin-seller-privacy-policy-page">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        <div class="col-sm-6">
          <h4 class="mb-0"><i class="fas fa-store mr-2 text-primary-theme"></i>Seller Privacy Policy & Terms</h4>
          <p class="text-muted mb-0 small">Privacy policy and terms & conditions shown to sellers.</p>
        </div>
        <div class="col-sm-6">
...
<style>
    .admin-seller-privacy-policy-page .text-primary-theme { color: var(--color-orange); }

    .admin-seller-privacy-policy-page .btn-primary-theme {
        background: var(--color-orange);
        border-color: var(--color-orange);
        color: #fff;
        font-weight: 600;
    }
    .admin-seller-privacy-policy-page .btn-primary-theme:hover { background: var(--color-orange-dark); border-color: var(--color-orange-dark); color: #fff; }

    .admin-seller-privacy-policy-page .attribute-card { border: none; border-radius: 10px; box-shadow: 0 1px 6px rgba(0,0,0,0.06); }
    .admin-seller-privacy-policy-page .attribute-card-header {
        background: #fff;
        border-bottom: 1px solid rgba(0,0,0,0.06);
        gap: 10px;
        border-radius: 10px 10px 0 0;
    }
    .admin-seller-privacy-policy-page .header-icon {
        width: 34px; height: 34px; border-radius: 8px;
        display: flex; align-items: center; justify-content: center;
        color: #fff; font-size: 14px; flex: none;
    }
    .admin-seller-privacy-policy-page .header-icon.bg-set { background: var(--color-orange); }

    .admin-seller-privacy-policy-page .btn-success {
        background: var(--color-orange);
        border-color: var(--color-orange);
    }
    .admin-seller-privacy-policy-page .btn-success:hover {
