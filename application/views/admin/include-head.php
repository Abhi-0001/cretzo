<head>
    ...
    <link rel="stylesheet" href="<?= add_ver(base_url('assets/admin/css/tempusdominus-bootstrap-4.min.css')) ?>">
    <!-- iCheck -->
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?= add_ver(base_url('assets/admin/css/jqvmap.min.css')) ?>">
    <!-- Ekko Lightbox -->
    ...
    <!-- intlTelInput -->
    <link rel="stylesheet" href="<?= add_ver(base_url('assets/admin/css/intlTelInput.css')) ?>" />
    ...
    <link rel="stylesheet" href="<?= add_ver(base_url('assets/admin/css/jquery.fancybox.min.css')) ?>" />
    <!-- chat -->
